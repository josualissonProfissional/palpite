-- Versao final da pontuacao com empate, colocada no schema palpite
-- para permitir teste via RPC. Substitui a versao no palpite_private.
...
begin
  ...
  -- PONTUACAO: posicoes empatadas (todos com mesmo num de votos) dao ponto pra todos
...
-- Tambem atualiza a versao no palpite_private para o process_best_player_windows usar
